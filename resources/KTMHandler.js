       ...
       function handleBaseStationUpdate(newBaseStation) {
                ...
                toggleTrainScheduleTableVisibility();                
       ...
       function showTrainScheduleTable(stationName, direction) { 
       ...
       function toggleTrainScheduleTableVisibility() {   
           ...
           if (!tableSchedule) {
           	   showTrainScheduleTable(baseStationParam,"up");
           	   showTrainScheduleTable(baseStationParam,"down");
               tableSchedule = document.querySelector("#trainScheduleTable");
               tableLegend = document.querySelector("#trainScheduleLegend");
